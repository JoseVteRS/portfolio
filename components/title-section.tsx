...
const TitleHeader = ({ children, dark = false, subtitle }: Props) => {
  return (
    <div className="mb-12">
      {dark ? (
        <>
          <h1 className="-tracking-wide text-transparent p-4 section-title font-title font-black bg-clip-text bg-gradient-to-r from-green-600 to-purple-700 text-center">
            {children}
          </h1>
          <p className="font-text text-transparent bg-clip-text bg-gradient-to-r from-gray-700 via-gray-900 to-black text-2xl font-semibold text-center">
            {subtitle}
          </p>
        </>
      ) : (
